...
The two components of the basal shear stress $\boldsymbol{\tau} = \rho u_{*}\boldsymbol{u}_{*}$, constant in a flat bottom situation, can then be written without loss of generality as:
\begin{align}
