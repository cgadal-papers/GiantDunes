...
.. "Processing/meteo_data_analysis_plot.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_Processing_meteo_data_analysis_plot.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_Processing_meteo_data_analysis_plot.py:
...
.. _sphx_glr_download_Processing_meteo_data_analysis_plot.py:
